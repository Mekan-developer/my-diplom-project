        ...
        $(document).ready(function(){
            ...
            $("#frm-check-bal").submit(function(){
                $.ajax({
                    ...
                    success: function(response, status , http){                        
                        var hrs=Math.floor(response / 3600);
                        var mins=parseFloat(Math.floor(response % 3600) / 60).toFixed(2);
                        var secs=Math.floor(response % 3600) % 60;
                        $("#time").html("Hours: "+hrs+"<br> Minutes: "+mins+"<br> Seconds: "+secs);
                        $("#barcode").val("");
                    }
